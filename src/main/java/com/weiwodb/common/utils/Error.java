...
public class Error {
    ...
    public static final Exception FileCannotREADException = new RuntimeException("File cannot write");
    public static final Exception FileCannotWRITEException = new RuntimeException("File cannot read ");
